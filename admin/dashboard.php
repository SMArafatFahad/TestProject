...
?>
													...
													<div class="stat-panel-title text-uppercase">Teams</div>
												</div>
											</div>
...
<?php 
$reciver = 'Admin';
$sql1 ="SELECT id from  add_player";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Players</div>
												</div>
											</div>
